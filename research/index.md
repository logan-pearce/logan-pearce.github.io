...
| ![NIRC2 Image and Astrometry](../img/GSC6214_2017_color1_sm.png) {:height="36px" width="36px"}|
|:---:|
...
| ![Accepted Orbits](../img/GSC6214_acceptedorbits_black_sm.png) {:height="36px" width="36px"}|
|<sub><sup> 100 randomly selected orbits from the posterior of accepted orbital parameters from the OFTI algorithm. </sup></sub> |
